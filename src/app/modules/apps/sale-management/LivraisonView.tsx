...
const LivraisonView: React.FC<Props> = ({className, sale}) => {
  ...
  const {toPDF, targetRef} = usePDF({filename: `bonlivraison-${saleData?.client?.fullname}.pdf`})
  useEffect(() => {
              ...
              <div className='card-body'>
                <div className='d-flex flex-row justify-content-between'>
                  ...
                  <div className='d-flex flex-column text-end mt-5'>
                    <h4 className='mb-5 '>Bon de livraison</h4>
