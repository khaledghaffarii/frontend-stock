...
const SaleListSearchLivraison = () => {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      try {
        ...
        await createMultipleSales(file, token)
  ...
  return (
    <div className='d-flex flex-md-row w-75 justify-content-between'>
      {isLoading && <SaleListLoading />} {/* Affichage de l'indicateur de chargement */}
...
export {SaleListSearchLivraison}
